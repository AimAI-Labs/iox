...
export const PRESET_ACTIONS: PresetActionTemplate[] = [
  ...
  },
  {
    ...
    template: {
      ...
      icon: 'Kimi',
      actionType: 'web',
      urlTemplate: 'https://www.kimi.com/',
      inputSelector: "div[contenteditable='true'], textarea, [contenteditable='true']",
      submitSelector: "button[data-testid*='send'], button.send-button, div[role='button'][aria-label*='发送'], button[type='submit']",
      autoSubmit: true,
      copyToClipboard: false,
      enabled: true,
    },
